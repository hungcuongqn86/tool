    ...
    1: [function (e, t, n) {
        ...
        function x() {
            ...
            if(e==""){
                ...
                if(container){
					...
					console.log('ninicuong1: ', e);
					
                }else{
                    // console.log('ninicuong2: ', container.length);
        ...
        function N() {
            ...
            if (u.length) {
                ...
                u = $(".sku-item-wrapper, .next-table-row");
                if (u.length) {
                    for (var h = 0; h < u.length; h++) {
                        l = u[h];
                        a = {
                        ...
                        if("undefined" != typeof n && n > 0){
                            e = $(l).find(".sku-item-left .discountPrice-price, .next-table-cell-wrapper .price").text().replace(/[^0-9\.]/g, '');
                            t = $(l).find(".sku-item-left .sku-item-name, .next-table-cell-wrapper .specification-cell .normal-text").text();
                            a.qty = n;
        ...
        function F() {
            ...
            $("#J_Title, .tb-detail-hd, #mod-detail-price, .od-pc-offer-title-contain, .od-pc-title-contain").append(r)
        }
        ...
        var W = {
            ...
            he = $('<div id="cart-thqc-warning"></div>'), pe = $("#J_box_buycart, #J_juValid, .tb-action, .obj-order, .order-button-children, .order-button-wrapper, .od-pc-offer-payment-contain, .order-form-button-wrapper"),
            de = ae.createClass({
