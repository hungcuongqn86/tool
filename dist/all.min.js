    ...
    1: [function (e, t, n) {
        ...
        function N() {
            ...
            if (u.length) {
                ...
                u = $("#sku-count-widget-wrapper .sku-item-wrapper");
                if (u.length) {
                    for (var h = 0; h < u.length; h++) {
                        l = u[h];
                        a = {
        ...
        function O() {
            ...
            if(isNaN(e) && "object" != typeof e){
                $('div.price-box span.price-text').each(function(ind, el) {
                    e = parseFloat($(el).text());
                });
            }

            if(isNaN(e) && "object" != typeof e){
                e = $("#sku-count-widget-wrapper").find("div.sku-item-wrapper:first").find("div.sku-item-left").find("div.discountPrice-price").text().replace(/[^0-9\.]/g, '');
                e = parseFloat(e);
            }
            ...
            "undefined" != typeof r && (r = JSON.parse(r)), "object" == typeof r && (o = parseInt(r.beginAmount)), z = N(), 0 == z[0].list.length && (z = [], z.push(D())), z.forEach(function (r) {
                ...
                s = s[s.length - 1], s = s.split(".")[0], s = s.split("_"), r.list.forEach(function (a) {
                    ...
                    var u = {
                        ...
                        price: a.price,
                        price_arr: k(),
                        size: a.skuName + a.size,
                        sizetxt: a.skuName + a.size,
                        color: a.color,
                        colortxt: a.color,
                        amount: a.qty,
                        beginAmount: o,
        ...
        var W = {
            ...
            he = $('<div id="cart-thqc-warning"></div>'), pe = $("#J_box_buycart, #J_juValid, .tb-action, .obj-order, .order-button-children, .order-button-wrapper, .od-pc-offer-payment-contain"),
            de = ae.createClass({
