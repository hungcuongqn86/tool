    ...
    1: [function (e, t, n) {
        ...
        function N() {
            var e, t, n, i = [], o = [], r = $(".tab-pane img").attr("src"),
                s = $("ul.list-leading div.active a.selected img").attr("alt");
            // console.log('1232432432342', s);
        ...
        function L() {
            o(q, function (e) {
                if(typeof e.tbex_thqc_token === 'undefined' || e.tbex_thqc_token === null) {
                    alert('Phiên làm việc hết hạn! Bạn cần đăng nhập QC247 trước khi đặt hàng!');
