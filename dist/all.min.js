!function (e, t) {
    ...
    1: [function (e, t, n) {
        ...
        function F() {
            if (j()) return !1;
            var e = "", t = "", n = k(), i = "";
            if ("1688" == oe) if ($(".mod-detail-purchasing").length) if (t = $(".mod-detail-purchasing").attr("data-mod-config"), t.length > 0 && (t = JSON.parse(t)), "object" == typeof t && (t = parseInt(t.max)), "number" == typeof t && (e += '<dl><dd style="width:100%"><span class="text-danger">Shop hiện còn <b>' + t + "</b> sản phẩm</span></dd></dl>"), "number" == typeof n) i = Math.round(n * ie.rate).format(); else {
                if (n.length > 0) {
        ...
        var W = {
            ...
            he = $('<div id="cart-thqc-warning"></div>'), pe = $("#J_box_buycart, #J_juValid, .tb-action, .obj-order, .order-button-children"),
            de = ae.createClass({
